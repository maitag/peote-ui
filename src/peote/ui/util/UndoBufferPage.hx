...
class UndoBufferPage
{
	var buffer:Vector<UndoItemPage>;
	
	var prevItem:UndoItemPage;
	...
	{
		buffer = new Vector<UndoItemPage>(size+1);
	}
	...
	public inline function undo():UndoItemPage 
	{		
	...
	public inline function redo():UndoItemPage
	{		
