...
class UITextLineT extends peote.ui.interactive.Interactive implements peote.ui.interactive.interfaces.ActionTextLine implements peote.ui.interactive.interfaces.InputFocus implements peote.ui.interactive.interfaces.InputText {
	...
	public inline function setStyle(glyphStyle:peote.ui.style.FontStyleTiled, from:Int = 0, to:Null<Int> = null) {
	...
	public inline function insertChar(char:String, position:Int, glyphStyle:peote.ui.style.FontStyleTiled = null) {
	...
	public inline function insertChars(chars:String, position:Int, glyphStyle:peote.ui.style.FontStyleTiled = null) {
	...
	var _onResizeTextWidth : (UITextLineT, Float, Float) -> Void = null;
	var _onChangeXOffset : (UITextLineT, Float, Float) -> Void = null;
	public var onResizeTextWidth : (UITextLineT, Float, Float) -> Void = null;
	public var onChangeXOffset : (UITextLineT, Float, Float) -> Void = null;
	public var onInsertText : (UITextLineT, Int, Int, String) -> Void = null;
	public var onDeleteText : (UITextLineT, Int, Int, String) -> Void = null;
	public var onResizeWidth(never, set) : (UITextLineT, Int, Int) -> Void;
	inline function set_onResizeWidth(f:(UITextLineT, Int, Int) -> Void):(UITextLineT, Int, Int) -> Void return setOnResizeWidth(this, f);
	public var onResizeHeight(never, set) : (UITextLineT, Int, Int) -> Void;
	inline function set_onResizeHeight(f:(UITextLineT, Int, Int) -> Void):(UITextLineT, Int, Int) -> Void return setOnResizeHeight(this, f);
	public var onPointerOver(never, set) : (UITextLineT, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerOver(f:(UITextLineT, peote.ui.event.PointerEvent) -> Void):(UITextLineT, peote.ui.event.PointerEvent) -> Void return setOnPointerOver(this, f);
	public var onPointerOut(never, set) : (UITextLineT, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerOut(f:(UITextLineT, peote.ui.event.PointerEvent) -> Void):(UITextLineT, peote.ui.event.PointerEvent) -> Void return setOnPointerOut(this, f);
	public var onPointerMove(never, set) : (UITextLineT, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerMove(f:(UITextLineT, peote.ui.event.PointerEvent) -> Void):(UITextLineT, peote.ui.event.PointerEvent) -> Void return setOnPointerMove(this, f);
	public var onPointerDown(never, set) : (UITextLineT, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerDown(f:(UITextLineT, peote.ui.event.PointerEvent) -> Void):(UITextLineT, peote.ui.event.PointerEvent) -> Void return setOnPointerDown(this, f);
	public var onPointerUp(never, set) : (UITextLineT, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerUp(f:(UITextLineT, peote.ui.event.PointerEvent) -> Void):(UITextLineT, peote.ui.event.PointerEvent) -> Void return setOnPointerUp(this, f);
	public var onPointerClick(never, set) : (UITextLineT, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerClick(f:(UITextLineT, peote.ui.event.PointerEvent) -> Void):(UITextLineT, peote.ui.event.PointerEvent) -> Void return setOnPointerClick(this, f);
	public var onMouseWheel(never, set) : (UITextLineT, peote.ui.event.WheelEvent) -> Void;
	inline function set_onMouseWheel(f:(UITextLineT, peote.ui.event.WheelEvent) -> Void):(UITextLineT, peote.ui.event.WheelEvent) -> Void return setOnMouseWheel(this, f);
	public var onDrag(never, set) : (UITextLineT, Float, Float) -> Void;
	inline function set_onDrag(f:(UITextLineT, Float, Float) -> Void):(UITextLineT, Float, Float) -> Void return setOnDrag(this, f);
	public var onFocus(never, set) : UITextLineT -> Void;
	inline function set_onFocus(f:UITextLineT -> Void):UITextLineT -> Void return setOnFocus(this, f);
}