...
class UITextPageP extends peote.ui.interactive.Interactive implements peote.ui.interactive.interfaces.ActionTextPage implements peote.ui.interactive.interfaces.InputFocus implements peote.ui.interactive.interfaces.InputText {
	public var page(default, null) : peote.ui.packed.PageP = null;
	var pageLine : peote.ui.packed.PageLineP = null;
	...
	public var fontProgram(default, null) : peote.ui.packed.FontProgramP;
	public var font(default, null) : peote.ui.packed.FontP;
	...
	inline function _setCreateSelection(_x:Int, _y:Int, _width:Int, _height:Int, y_offset:Float, addUpdate:Bool, create:Bool, updateStyle:Bool) {
		...
		var _pageLine:peote.ui.packed.PageLineP;
	...
	public inline function setStyle(glyphStyle:peote.ui.style.FontStylePacked, fromLine:Int = 0, fromPosition:Int = 0, ?toLine:Null<Int>, ?toPosition:Null<Int>) {
		fontStyle = glyphStyle;
		fontProgram.pageSetStyle(page, fontStyle, fromLine, fromPosition, toLine, toPosition, isVisible);
	}
	public inline function appendChars(chars:String, glyphStyle:peote.ui.style.FontStylePacked = null) {
		setOldTextSize();
	...
	public inline function insertChars(chars:String, lineNumber, position, glyphStyle:peote.ui.style.FontStylePacked = null) {
	...
	inline function _deleteChar(_pageLine:peote.ui.packed.PageLineP, lineNumber:Int, position:Int) {
	...
	inline function _addLinefeed(_pageLine:peote.ui.packed.PageLineP, lineNumber:Int, position:Int) {
	...
	inline function _removeLinefeed(_pageLine:peote.ui.packed.PageLineP, lineNumber:Int) {
	...
	var _onResizeTextWidth : (UITextPageP, Float, Float) -> Void = null;
	var _onResizeTextHeight : (UITextPageP, Float, Float) -> Void = null;
	var _onChangeXOffset : (UITextPageP, Float, Float) -> Void = null;
	var _onChangeYOffset : (UITextPageP, Float, Float) -> Void = null;
	public var onResizeTextWidth : (UITextPageP, Float, Float) -> Void = null;
	public var onResizeTextHeight : (UITextPageP, Float, Float) -> Void = null;
	public var onChangeXOffset : (UITextPageP, Float, Float) -> Void = null;
	public var onChangeYOffset : (UITextPageP, Float, Float) -> Void = null;
	public var onInsertText : (UITextPageP, Int, Int, Int, Int, String) -> Void = null;
	public var onDeleteText : (UITextPageP, Int, Int, Int, Int, String) -> Void = null;
	public var onResizeWidth(never, set) : (UITextPageP, Int, Int) -> Void;
	inline function set_onResizeWidth(f:(UITextPageP, Int, Int) -> Void):(UITextPageP, Int, Int) -> Void return setOnResizeWidth(this, f);
	public var onResizeHeight(never, set) : (UITextPageP, Int, Int) -> Void;
	inline function set_onResizeHeight(f:(UITextPageP, Int, Int) -> Void):(UITextPageP, Int, Int) -> Void return setOnResizeHeight(this, f);
	public var onPointerOver(never, set) : (UITextPageP, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerOver(f:(UITextPageP, peote.ui.event.PointerEvent) -> Void):(UITextPageP, peote.ui.event.PointerEvent) -> Void return setOnPointerOver(this, f);
	public var onPointerOut(never, set) : (UITextPageP, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerOut(f:(UITextPageP, peote.ui.event.PointerEvent) -> Void):(UITextPageP, peote.ui.event.PointerEvent) -> Void return setOnPointerOut(this, f);
	public var onPointerMove(never, set) : (UITextPageP, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerMove(f:(UITextPageP, peote.ui.event.PointerEvent) -> Void):(UITextPageP, peote.ui.event.PointerEvent) -> Void return setOnPointerMove(this, f);
	public var onPointerDown(never, set) : (UITextPageP, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerDown(f:(UITextPageP, peote.ui.event.PointerEvent) -> Void):(UITextPageP, peote.ui.event.PointerEvent) -> Void return setOnPointerDown(this, f);
	public var onPointerUp(never, set) : (UITextPageP, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerUp(f:(UITextPageP, peote.ui.event.PointerEvent) -> Void):(UITextPageP, peote.ui.event.PointerEvent) -> Void return setOnPointerUp(this, f);
	public var onPointerClick(never, set) : (UITextPageP, peote.ui.event.PointerEvent) -> Void;
	inline function set_onPointerClick(f:(UITextPageP, peote.ui.event.PointerEvent) -> Void):(UITextPageP, peote.ui.event.PointerEvent) -> Void return setOnPointerClick(this, f);
	public var onMouseWheel(never, set) : (UITextPageP, peote.ui.event.WheelEvent) -> Void;
	inline function set_onMouseWheel(f:(UITextPageP, peote.ui.event.WheelEvent) -> Void):(UITextPageP, peote.ui.event.WheelEvent) -> Void return setOnMouseWheel(this, f);
	public var onDrag(never, set) : (UITextPageP, Float, Float) -> Void;
	inline function set_onDrag(f:(UITextPageP, Float, Float) -> Void):(UITextPageP, Float, Float) -> Void return setOnDrag(this, f);
	public var onFocus(never, set) : UITextPageP -> Void;
	inline function set_onFocus(f:UITextPageP -> Void):UITextPageP -> Void return setOnFocus(this, f);
}